...
class LxWebsocketClient(WebsocketManager):
    ...
    def __init__(self, api_key: str = None) -> None:
        ...
        self._book_top: Deque = deque([], maxlen=3)  # TODO: add support for full-fledged orderbook depth calculations
    ...
    def _login(self):
        """Generate signed login info. Not needed for LX. Needed for BinanceUS."""
    ...
    def _handle_book_top(self, message: Dict) -> None:
        self._book_top.append(message)
    ...
    def _on_message(self, ws, raw_message: str) -> None:
        ...
        if message_type == 'book_top':
            if message['contract_id'] == 22232446:
                self._handle_book_top(message)
        #
